            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, user_1.User.findOrCreate({
                            ...
                            defaults: __assign(__assign({}, req.body), { password: (function () {
                                    var salt = bcrypt_1.default.genSaltSync(utils_1.saltRounds);
                                    var hash = bcrypt_1.default.hashSync(req.body.password, salt);
                                    return hash;
                                })() })
                        })];
                case 3:
                    _a = _b.sent(), user = _a[0], created = _a[1];
                    if (created) {
                        res.status(201).send("User ".concat(req.body.username, " was created."));
                    }
                    else {
