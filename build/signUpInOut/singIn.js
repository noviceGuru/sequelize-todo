...
var signIn = function (app) {
    app.post('/users/signin', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, algorithm, issued, fifteenMinutesInMs, expires, newSession, token, error_1;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (user && bcrypt_1.default.compareSync(req.body.password, user.password)) {
                        algorithm = "HS512";
                        issued = Date.now();
                        fifteenMinutesInMs = 15 * 60 * 1000;
                        expires = issued + fifteenMinutesInMs;
                        newSession = {
                            id: user.id,
                        ...
                        token = (0, jwt_simple_1.encode)(newSession, secret_1.SECRET_KEY, algorithm);
                        res.send({
