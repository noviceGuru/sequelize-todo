...
app.post('/users', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.User.create(req.body)];
            case 1:
                _a.sent();
                res.send('success');
                return [2 /*return*/];
...
app.get('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.User.findOne({ where: { id: req.params.id } })];
            case 1:
                user = _a.sent();
                res.send(user);
                return [2 /*return*/];
...
app.delete('/users/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.User.destroy({ where: { id: req.params.id } })];
            case 1:
                _a.sent();
                res.send("User with id ".concat(req.params.id, " was deleted."));
                return [2 /*return*/];
        }
    });
}); });
